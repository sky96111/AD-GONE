...
#### AD-GONE过滤列表基于anti-AD，将额外提供Clash规则。同时，对于某些既是正常使用到的域名又是广告域名，AD-GONE将予以放行。通过细化规则分类，针对不通人群需求，对日常使用影响降至最低。由于dnsmasq和clash不便于支持子域名为正常域名的情况，首选推荐AdGuardHome

## 使用

## TODO

- [x] 移除anti-AD中对日常有影响的域名
- [x] 初步Clash规则支持
- [ ] 化简的Clash规则支持
- [ ] 规则分类为宽容、严格
- [ ] CI自动生成各规则
